...
#pragma warning restore 0649
        ...
        {
            get { if (gameObject.activeInHierarchy) return RB.position; return transform.position; }
            set { if (gameObject.activeInHierarchy) RB.position = value; else transform.position = value; }
        }

        public Quaternion rotation
        {
            get { if (gameObject.activeInHierarchy) return RB.rotation; return transform.rotation; }
            set { if (gameObject.activeInHierarchy) RB.rotation = value; else transform.rotation = value; }
        }
